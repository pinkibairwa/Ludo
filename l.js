class Dice {
    ...
    roll() {
        ...
        if (this.count == 1) {
            document.getElementById("die").style.backgroundImage = 'url("https://cdn2.iconfinder.com/data/icons/dice-roll/100/dice_black_1-512.png")';
        }
        if (this.count == 2) {
            document.getElementById("die").style.backgroundImage = 'url("https://cdn2.iconfinder.com/data/icons/dice-roll/100/dice_black_2-512.png")';
        }
        if (this.count == 3) {
            document.getElementById("die").style.backgroundImage = 'url("https://th.bing.com/th/id/OIP.SSq8ha6p4u2GSX85PFM7OwHaHa?pid=ImgDet&w=184&h=184&c=7&dpr=1.3")';
        }
        if (this.count == 4) {
            document.getElementById("die").style.backgroundImage = 'url("https://cdn2.iconfinder.com/data/icons/dice-roll/100/dice_black_4-512.png")';
        }
        if (this.count == 5) {
            document.getElementById("die").style.backgroundImage = 'url("https://th.bing.com/th/id/OIP.62_fketdj7hCamyBb9gYzAAAAA?rs=1&pid=ImgDetMain")';
        }
        if (this.count == 6) {
            document.getElementById("die").style.backgroundImage = 'url("https://th.bing.com/th/id/OIP.xX_EuQRMG0L7QwegnxvgYAAAAA?pid=ImgDet&w=181&h=181&c=7&dpr=1.3")';
        }
        if (this.type == 1) {
            if (this.r.checker()) {
